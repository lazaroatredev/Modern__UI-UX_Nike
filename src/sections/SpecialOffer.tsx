  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex-1 flex flex-col px-4">
        ...
        <p className="mt-4 lg:max-w-lg info-text">Mavigate a realm of possibilities designed tu fulfil you unique desires, surpassing the loftiest expectations. Your journey with us is nothing short of exceptional</p>
